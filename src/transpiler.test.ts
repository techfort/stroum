...
describe("Transpiler", () => {
  describe("literals", () => {
    ...
    it("should transpile interpolated string with identifier", () => {
      ...
      // biome-ignore lint/suspicious/noTemplateCurlyInString: testing transpiler output that contains template literals
  ...
  describe("pipe expressions", () => {
    ...
    it("should throw when a pipe stage has args but no _ placeholder", () => {
      ...
      expect(() => transpile("data |> step1 |> step2()")).toThrow(
        /placeholder/,
      );
    });
